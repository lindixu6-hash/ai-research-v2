...
| 产品 | 定位 | 优点 | 缺点 |
|------|------|------|------|
| **秘塔搜索** | 学术检索 | 接入学术数据库 | 交互体验糟糕，无法深入研究 |
| **Kimi 研究模式** | 多步推理 | 真正浏览网页，循环验证 | 澄清问题多余，流程太快 |
| **Deepseek 搜索** | 极简型 | 快速响应 | 只能看摘要，质量不稳定 |
| **Aminer** | 多 Agent 协作 | 并行搜索 | 不筛选结果，脏数据多 |
| **Wisper Paper** | 论文验证 | 结果筛选机制 | 不帮助总结 |
